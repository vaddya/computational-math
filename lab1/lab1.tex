...
\captionof{lstlisting}{main.cpp. Функция, вычисляющая значение полинома Лагранжа 10-ой степени в точке $x_0$}
...
\captionof{lstlisting}{main.cpp. Функция, вычисляющая значение сплайн функции в точке $x_0$}
