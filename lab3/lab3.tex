...
На рисунке \ref{plot:euler_error} изображена погрешность, полученная при вычислении решения с использование усовершенствованного метода ломанных Эйлера. Как видно, на всем промежутке $[1, 2]$ погрешность монотонно возрастает, что объясняется накоплением глобальной погрешности.
